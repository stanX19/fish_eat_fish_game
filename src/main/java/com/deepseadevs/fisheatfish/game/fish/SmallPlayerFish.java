...
public class SmallPlayerFish extends BasePlayerFish {
    public SmallPlayerFish() {
        super();
        leftFishAnimation = new Animation("file:src/main/assets/sprites/orenleft.png", 0.75, new Bound(0,17,50,45));
        rightFishAnimation = new Animation("file:src/main/assets/sprites/orenright.png", 0.75, new Bound(15,17,65,45));
    }
}