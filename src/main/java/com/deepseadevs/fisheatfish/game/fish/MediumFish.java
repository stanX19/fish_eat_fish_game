...
public class MediumFish extends BaseFish {
    public MediumFish() {
        super(100, 60, 40);
        leftFishAnimation = new Animation("file:src/main/assets/sprites/greenleft.png", 0.1, new Bound(11,1,51,36));
        rightFishAnimation = new Animation("file:src/main/assets/sprites/greenright.png", 0.1, new Bound(11,1,51,36));
    }
}
