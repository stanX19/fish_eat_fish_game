...
public class LargeFish extends BaseFish {
    public LargeFish() {
        super(200, 120, 80);
        leftFishAnimation = new Animation("file:src/main/assets/sprites/pacmanleft.png", 0.25, new Bound(8,14,111,112));
        rightFishAnimation = new Animation("file:src/main/assets/sprites/pacmanright.png", 0.25, new Bound(8,14,111,112));
    }
}
