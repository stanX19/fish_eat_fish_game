...
public class LargeFish extends BaseFish {
    public LargeFish() {
        super(200, 120, 80);
        leftFishAnimation = new Animation("file:src/main/assets/sprites/pacmanleft.png", 0.25, new Bound(1,1,103,98));
        rightFishAnimation = new Animation("file:src/main/assets/sprites/pacmanright.png", 0.25, new Bound(1,1,103,98));
    }
}
